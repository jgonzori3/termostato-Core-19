...
//creamos un progrmador que determina la temperatura ideal en cada momento
const horario = [
 { hora: "07:00",
 temperatura: 22
 },
...
const programador = new Programador(horario);
...
programador.on('ideal',function(temperatura){
      console.log("nueva temperatura ideal : "+temperatura+"ºC");
